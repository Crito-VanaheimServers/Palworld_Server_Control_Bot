...
class ArkFilesData {
    ...
    _playerFactory(file) {
        ...
        return {
            ...
            PlayerId: binaryParser.getSteamId(),
            ...
            //TotalEngramPoints: binaryParser.getProperty('PlayerState_TotalEngramPoints') + 1
    ...
    _tribeFactory(file) {
       let data = this._readFile(file),
        ...
        return {
            ...
            TribeName: binaryParser.getProperty('TribeName'),
            //OwnerId: binaryParser.getProperty('OwnerPlayerDataID'),
            TribeIdNum: binaryParser.getProperty('TribeID')
            //Players: []
