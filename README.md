...
3/8/2024 Fixed player count issue and updated command line with new argument. Palworld no longer uses EpicApp=PalServer it was replaced with -publiclobby.
